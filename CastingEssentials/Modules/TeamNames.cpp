...
TeamNames::TeamNames() :
	m_OverrideCvars {
		ConVar("ce_teamnames_blu", "", FCVAR_NONE, "Overrides mp_tournament_blueteamname."),
		ConVar("ce_teamnames_red", "", FCVAR_NONE, "Overrides mp_tournament_redteamname.")
	},

	ce_teamnames_swap("ce_teamnames_swap", []() { GetModule()->SwapTeamNames(); }, "Swaps the values of ce_teamnames_blu and ce_teamnames_red.")
{
